                    ...
                    <form name="myform" action="{{ url('admin/role/update') }}" method="post">
                        <table id="Role_list1" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover table-m">
                            <tbody>
                                <tr>
                                    <th width="20%">角色名称</th>
                                    <td width="80%"><input type="text" style="width:300px" name="role_name" value="{{ $info['role_name'] }}"/>
                                        <br />
                                ...
                                <tr>
                                    <th width="20%">角色描述</th>
                                    <td width="80%"><textarea style="width:80%; height:100px;" name="role_description">{{ $info['role_description'] }}</textarea><br /><span class="ps">角色描述不能为空</span></td>
                                </tr>
