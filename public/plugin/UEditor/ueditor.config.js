...
(function () {
    ...
    window.UEDITOR_CONFIG = {
		...
		,whitList: {
			...
			abbr:   ['title', 'class', 'style' ,'id'],
			address: ['class', 'style' ,'id'],
			area:   ['shape', 'coords', 'href', 'alt'],
			article: ['class', 'style' ,'id'],
			aside:  ['class', 'style' ,'id'],
			audio:  ['autoplay', 'controls', 'loop', 'preload', 'src', 'class', 'style' ,'id'],
			b:      ['class', 'style' ,'id'],
			bdi:    ['dir'],
			bdo:    ['dir'],
			big:    ['class', 'style' ,'id'],
            ...
            embed:  ['src', 'height', 'width', 'style', 'allowFullScreen', 'quality', 'align', 'allowScriptAccess', 'type'],
            iframe: ['src', 'height', 'width', 'style', 'frameborder', 'id', 'class', 'allowFullScreen']
		}
    };
